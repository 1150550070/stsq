...
import com.sht.stsq.config.WxOpenConfig;
...
import com.sht.stsq.model.dto.user.UserAddRequest;
import com.sht.stsq.model.dto.user.UserLoginRequest;
import com.sht.stsq.model.dto.user.UserQueryRequest;
import com.sht.stsq.model.dto.user.UserRegisterRequest;
import com.sht.stsq.model.dto.user.UserUpdateMyRequest;
import com.sht.stsq.model.dto.user.UserUpdateRequest;
...
import static com.sht.stsq.service.impl.UserServiceImpl.SALT;
...
public class UserController {
    ...
    public BaseResponse<List<Integer>> getUserSignOut(Integer year ,HttpServletRequest request) {
        User loginUser = userService.getLoginUser(request);
        Long userId = loginUser.getId();
        if (userId == null) {
            throw new BusinessException(ErrorCode.PARAMS_ERROR);
        }
        List userSignIn = userService.getUserSignIn(userId, year);
