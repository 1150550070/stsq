...
import com.sht.stsq.constant.FileConstant;
import com.sht.stsq.exception.BusinessException;
import com.sht.stsq.manager.OssManager;
import com.sht.stsq.model.dto.file.UploadFileRequest;
import com.sht.stsq.model.entity.User;
import com.sht.stsq.model.enums.FileUploadBizEnum;
...
public class FileController {
    ...
    public BaseResponse<String> uploadFile(@RequestPart("file") MultipartFile multipartFile,
        ...
        try {
            ...
            ossManager.putObject(filepath, file.getAbsolutePath());
            // 返回可访问地址
